...
"En 1866, los oceanos del mundo son aterrorizados por un supuesto monstruo marino que hunde barcos. "
"El profesor frances Pierre Aronnax, un apasionado biologo marino, su leal sirviente Conseil y el "
"temperamental arponero canadiense Ned Land se unen a una expedicion a bordo del Abraham Lincoln para "
"cazar a la bestia. Tras meses de busqueda infructuosa, finalmente localizan al monstruo. Sin embargo, "
"durante el ataque, los tres hombres son lanzados al mar y descubren la impactante verdad: no es una "
"criatura, sino el Nautilus, un submarino de tecnologia avanzada. Son hechos prisioneros por su "
"enigmatico comandante, el Capitan Nemo. Nemo es un hombre brillante, culto y profundamente misantropo "
"que ha roto todo lazo con la humanidad y la superficie. Ha disenado el Nautilus para vivir exclusivamente "
"en el oceano, alimentandose de sus recursos y navegando en total libertad. Aronnax, fascinado por las "
"maravillas cientificas y la biblioteca del submarino, acepta su cautiverio, mientras que Ned Land solo "
"piensa en escapar. Asi comienza un viaje de veinte mil leguas por los fondos oceanicos. Nemo les muestra "
"un mundo subacuatico lleno de maravillas: pasean por bosques marinos, exploran las ruinas sumergidas de "
"la Atlantida, bucean en las minas de carbon de islas volcanicas y descubren la vida en las profundidades "
"abisales. La travesia los lleva por los mares del JapOn, las costas de Nueva Guinea, el oceano Indico y "
"el Mediterraneo. En un momento crucial, el Nautilus queda atrapado bajo el hielo en el Polo Sur. Tras "
"unos dias angustiosos donde casi mueren asfixiados por la falta de oxigeno, logran liberar el submarino "
"y escapar. Mas tarde, enfrentan a un terrible calamar gigante en el que un tripulante pierde la vida, "
"mostrando el lado vulnerable de Nemo. Sin embargo, la admiracion de Aronnax se torna en horror cuando "
"descubre la verdadera naturaleza del Capitan. Nemo utiliza el Nautilus como un instrumento de venganza "
"contra las naciones imperialistas que oprimen a los pueblos. En un acto devastador, el submarino embiste "
"y hunde un barco de guerra, ahogando a toda su tripulacion. Aronnax comprende que Nemo no es solo un "
"cientifico, sino un hombre consumido por el odio y la sed de sangre. Decididos a huir antes de que el "
"capitan los lleve a la perdicion, los tres prisioneros esperan su oportunidad. Mientras el Nautilus es "
...
"por un pescador. Aronnax regresa a la civilizacion, pero su mente queda para siempre atrapada en las "
"profundidades. Aunque se salva, el profesor nunca olvida al Capitan Nemo, ni las insondables maravillas "
"y terrores que ocultaban los oceanos, preguntandose eternamente si el misterioso comandante y su "
"submarino finalmente encontraron la paz en el abismo. Hoy, mirando el mar, escucho el eco de sus "
"helices, recordando que bajo las olas yace el legado de un genio que eligio las tinieblas del oceano "
"antes que la luz.";
...
void setup() {
  ...
  showSplashScreen();      // Primer splash: CW Aventuras - 20.000 Leguas
  showCreditsScreen();     // Segundo splash: Creditos a LU6APR - GP 3.0
  showSpeedSelection();
}
